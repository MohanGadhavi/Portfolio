...
const Hero = () => {
  return (
    <section
      id="home"
      className="h-[calc(100vh-6rem)] md:min-h-screen pt-32 flex flex-col bg-gradient-to-tr from-accent/10 to-white dark:bg-none dark:bg-black text-white transition-colors duration-300 relative"
    >
      {/* Background Glow */}
